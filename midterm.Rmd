...
```
```{r}
str_replace_all(twDates,"(民國)|(月)","") #另一種方法
```
...
```{r ans53}
str_split(twDates2,"年") -> dataList
map(dateList,~.[[2]]) -> mm    #取每個元素的第二個
unlist(mm) -> oo    #原本是list,改成character
str_c(as.character(westYears),oo,"01",sep="-") -> westDates 
